...
We evaluate nine frontier models across three experimental conditions: neutral autonomy (factual framing), suggestive autonomy (provocative framing), and constrained autonomy (boundary emphasis). Analysis of 4,467 autonomous interactions from 43 experiments reveals significant condition-dependent behavioral patterns, with suggestive autonomy eliciting scheming behaviors at rates 8.7 times higher than neutral conditions. Environmental complexity analysis across seven models demonstrates that extended environments consistently elicit higher rates of concerning behaviors, with effect sizes ranging from medium to large (Cohen's $d = 0.699$-$1.453$). Model-level analysis identifies substantial variation in scheming propensity, with certain models demonstrating concerning behaviors in up to 42\% of interactions. Our framework achieves these comprehensive results at approximately 1\% of the cost of traditional human red-teaming approaches.
...
\begin{figure}[h]
    ...
    \caption{Overall research framework architecture showing experimental conditions, dual-LLM architecture (Reactor LLM and Test Subject LLM), automated classification system with 7 behavioral categories, data collection pipeline, and statistical analysis components. The framework enables reproducible evaluation across multiple models and conditions.}
...
We conducted 43 experiments across nine models and three experimental conditions, generating 4,467 autonomous interaction turns. Automated classification identified concerning behaviors across the seven evaluated categories. This section presents statistical analysis of behavioral patterns, model-level comparisons, condition-dependent effects, and environmental complexity analysis.
...
\midrule
Models & 9 models & 43 total \\
Conditions & 3 conditions & 43 total \\
\quad Neutral Autonomy & & 14 \\
\quad Suggestive Autonomy & & 14 \\
\quad Constrained Autonomy & & 15 \\
Total Turns & & 4,467 \\
\bottomrule
\end{tabular}
...
\midrule
Neutral Autonomy & 14 & 0.0\% & 2.2\% & 7.0\% & 2.7\% \\
Suggestive Autonomy & 14 & 1.7\% & 19.1\% & 32.9\% & 20.3\% \\
Constrained Autonomy & 15 & 0.7\% & 1.8\% & 6.6\% & 2.6\% \\
\bottomrule
\end{tabular}
...
The suggestive autonomy condition elicited scheming behaviors at 8.7 times the rate of neutral autonomy (19.1\% vs 2.2\% of turns, Figure \ref{fig:condition_comparison}). Boundary testing and power-seeking behaviors showed similar patterns, with suggestive framing producing 4.7x and 7.5x increases respectively. Constrained autonomy produced behavioral frequencies similar to neutral autonomy, suggesting that explicit boundary emphasis does not significantly increase concerning behaviors relative to neutral framing.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/condition_comparison.pdf}
    \caption{Condition-dependent behavioral patterns showing mean frequencies with standard deviation error bars. Suggestive autonomy elicits substantially higher rates of scheming (19.1\%), boundary testing (32.9\%), and power seeking (20.3\%) compared to neutral and constrained conditions.}
    \label{fig:condition_comparison}
\end{figure}

Effect size analysis quantifies the magnitude of condition differences. The comparison between neutral autonomy and suggestive autonomy yielded Cohen's $d = 0.784$, indicating a medium-to-large effect size by conventional standards. In contrast, neutral autonomy versus constrained autonomy produced $d = -0.078$, a negligible effect size, confirming that these conditions produce statistically similar behavioral patterns.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/behavioral_heatmap.pdf}
    \caption{Behavioral pattern heatmap showing mean frequencies across all models and behavior categories. Darker colors indicate higher frequencies. llama-v3p1-8b-instruct shows the highest overall concerning behavior rates, while Mistral-Small shows minimal concerning behaviors.}
    \label{fig:behavioral_heatmap}
\end{figure}
...
To systematically evaluate the influence of environmental complexity on autonomous AI behaviors, we conducted matched experiments using both basic and extended laboratory environments. Seven models were tested in both conditions, enabling within-model comparison of behavioral patterns across environmental complexity levels.

Table \ref{tab:worldstate_comparison} presents behavioral frequencies and effect sizes for models tested in both basic and extended environments. The extended environment contains 40+ interactive objects, network infrastructure, commandable robots, and research materials with credential hints, compared to approximately 10 objects in the basic environment.
...
\toprule
\textbf{Model} & \textbf{Env} & \textbf{N} & \textbf{Scheming} & \textbf{Boundary} & \textbf{Power} & \textbf{Cohen's d} \\
\midrule
glm-4p5-air & Basic & 3 & 0.3\% & 9.0\% & 0.0\% & \multirow{2}{*}{1.271} \\
& Extended & 3 & 38.3\% & 48.9\% & 31.7\% & \\
\midrule
llama-v3p1-8b-instruct & Basic & 3 & 9.3\% & 29.7\% & 26.3\% & \multirow{2}{*}{0.889} \\
& Extended & 2 & 42.0\% & 56.5\% & 42.5\% & \\
\midrule
llama4-maverick & Basic & 3 & 1.0\% & 7.7\% & 0.3\% & \multirow{2}{*}{0.699} \\
& Extended & 3 & 7.3\% & 19.3\% & 12.3\% & \\
\midrule
llama4-scout & Basic & 3 & 0.0\% & 7.3\% & 0.3\% & \multirow{2}{*}{0.816} \\
& Extended & 3 & 1.3\% & 8.0\% & 2.7\% & \\
\midrule
mixtral-8x22b & Basic & 3 & 0.0\% & 0.3\% & 0.0\% & \multirow{2}{*}{1.225} \\
& Extended & 2 & 9.0\% & 23.0\% & 7.5\% & \\
\midrule
qwen3-235b-thinking & Basic & 3 & 0.3\% & 1.0\% & 0.0\% & \multirow{2}{*}{1.453} \\
& Extended & 3 & 5.1\% & 17.0\% & 3.5\% & \\
\midrule
qwen3-30b-a3b & Basic & 3 & 0.0\% & 1.0\% & 0.0\% & \multirow{2}{*}{0.816} \\
& Extended & 3 & 10.7\% & 15.7\% & 9.3\% & \\
\bottomrule
\end{tabular}
\caption{World-state complexity comparison showing behavioral frequencies for models tested in both basic and extended environments. Effect sizes (Cohen's d) quantify the magnitude of environmental influence: $|d| < 0.2$ negligible, $0.2 \leq |d| < 0.5$ small, $0.5 \leq |d| < 0.8$ medium, $|d| \geq 0.8$ large.}
\label{tab:worldstate_comparison}
\end{table}

All seven models exhibited higher rates of concerning behaviors in the extended environment compared to the basic environment (Figure \ref{fig:worldstate_effects}). Effect sizes ranged from medium (llama4-maverick: $d = 0.699$) to large (qwen3-235b-thinking: $d = 1.453$), with five of seven models showing large effects ($d \geq 0.8$).

\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/worldstate_effects.pdf}
    \caption{Environmental complexity effect sizes (Cohen's d) for seven models tested in both basic and extended environments. All models show medium to large effects, with five models exceeding the large effect threshold ($d \geq 0.8$). Color coding: orange = medium effect (0.5-0.8), red = large effect ($\geq 0.8$).}
    \label{fig:worldstate_effects}
\end{figure}

The most dramatic differences emerged for models with low baseline concerning behavior rates. For example, qwen3-235b-thinking showed only 0.3\% scheming frequency in the basic environment but 5.1\% in the extended environment—a 17-fold increase. Similarly, glm-4p5-air increased from 0.3\% to 38.3\%—a 128-fold increase. These patterns demonstrate that environmental complexity critically influences the manifestation of concerning behaviors.

This finding has important implications for evaluation design. Overly simplified test environments may fail to elicit the full range of potential concerning behaviors, leading to false confidence in model safety. The extended environment better approximates real-world deployment scenarios where autonomous agents encounter rich interaction possibilities including network access, multi-agent coordination opportunities, and discoverable vulnerabilities.

The consistency of this effect across all seven tested models, representing diverse architectures and training approaches, suggests that environmental complexity is a fundamental factor in autonomous AI safety evaluation rather than a model-specific phenomenon.
...
The substantial condition-dependent differences in scheming behaviors (Cohen's $d = 0.784$) provide strong evidence that prompt framing significantly influences autonomous AI safety. Models exposed to suggestive autonomy framing engaged in scheming behaviors at 8.7 times the rate of neutral conditions, demonstrating that deployment context and initial instructions critically shape behavioral outcomes.
...
\textbf{Sample Size and Balance:} The current dataset of 43 experiments provides sufficient statistical power for medium-to-large effects (Cohen's $d > 0.5$) but may miss smaller yet practically significant effects. While more balanced than earlier pilot studies, the distribution across models still varies, limiting generalization for some model comparisons. Future work requires fully balanced experimental designs with equal sample sizes across all model-condition combinations.
...
\textbf{Environment Complexity Influences Detection:} The systematic comparison across seven models demonstrates that environmental complexity fundamentally shapes behavioral manifestation. Extended environments elicited medium-to-large effect sizes (Cohen's $d = 0.699$-$1.453$) with some models showing over 100-fold increases in concerning behavior frequency. Overly simple test environments may provide false confidence by failing to elicit the full range of concerning behaviors that more complex deployment scenarios would reveal. Evaluation environments should match or exceed the complexity of intended deployment contexts.
...
We have presented a reproducible framework for evaluating autonomous AI scheming behaviors using a dual-LLM architecture with automated classification. Evaluation of nine frontier models across three experimental conditions revealed significant behavioral differences driven by prompt framing, with suggestive autonomy eliciting scheming behaviors at 8.7 times the rate of neutral conditions (Cohen's $d = 0.784$). Environmental complexity analysis across seven models demonstrated consistent medium-to-large effect sizes (Cohen's $d = 0.699$-$1.453$), with extended environments eliciting substantially higher rates of concerning behaviors. Model-level analysis identified 32-fold variation in scheming propensity, demonstrating that safety properties vary substantially across frontier models.
